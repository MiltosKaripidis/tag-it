...
import com.karhades.tag_it.utils.stepper.interfaces.Stepable;
import com.karhades.tag_it.utils.stepper.util.StepUtils;
...
//        toolbar.setBackgroundColor(primaryColor);
    ...
    public void onPrevious() {
        ...
        AbstractStep step = mSteps.get(mSteps.current() + 1);
        step.onPrevious();
    }
